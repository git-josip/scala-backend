package com.laplacian.scalabackendsampling.core.utils
...
object ConfigurationUtils
{
  ...
  private final val TYPE_NOT_SUPPORRTED_ERROR_FORMATTER = "%s type is not supported"
  ...
  def getConfigurationByKey[T](key: String)(implicit classManifest: Manifest[T]): T =
  {
    ...
    classManifest match {
      ...
      case _ => throw new RuntimeException(TYPE_NOT_SUPPORRTED_ERROR_FORMATTER.format(classManifest.runtimeClass.getSimpleName))
    }
  }
