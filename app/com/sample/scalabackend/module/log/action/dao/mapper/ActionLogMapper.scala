package com.sample.scalabackend.module.log.action.dao.mapper

import com.sample.scalabackend.module.log.action.domain.ActionType
import com.sample.scalabackend.core.slick.custommapper.CustomSlickMapper
import com.sample.scalabackend.module.log.action.domain.{ActionDomainType, ActionLogEntity, ActionType}
import com.sample.scalabackend.module.user.dao.sql.mapper.UserEntityMapper
